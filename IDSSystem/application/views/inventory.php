...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body>
		<div class="menu">
			<ul class="ca-menu">
				<li>
					<a href='<?php echo base_url();?>index.php/foodManager'>
						<span class="ca-icon">C</span>
						<div class="ca-content">
							<p class="ca-main">Manage Food</p>
						</div>
					</a>
				</li>

				<li>
					<a href='<?php echo base_url();?>index.php/categoryManager'>
						<span class="ca-icon">F</span>
						<div class="ca-content">
							<p class="ca-main">Manage Category</p>
						</div>
					</a>
				</li>

				<li>
					<a href='<?php echo base_url();?>index.php/cashierManager'>
						<span class="ca-icon">U</span>
						<div class="ca-content">
							<p class="ca-main">Manage Cashier</p>
						</div>
					</a>
				</li>
